    ...
    if (user) {
        try {
            ...
            if (docSnap.exists() && docSnap.data().role) {
                ...
                else if (role === 'club') window.location.href = 'club-dashboard.html';
